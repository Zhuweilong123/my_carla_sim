...
packages = [
    ...
    f"{package_name}.engine.routing",
    f"{package_name}.engine.reference_line",
...
package_dir = {
    ...
    f"{package_name}.engine.routing": "engine/routing",
    f"{package_name}.engine.reference_line": "engine/reference_line",
...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "safe_stop_node = lightweight_sim.engine.ros_nodes.safe_stop_node:main",
